"""
Sheet 3 Example: EXPRESSION ORALE

Process the EXPRESSION ORALE course sheet independently.
This sheet contains 10 students with 10 first-block grades and 0 component exams.
"""
...
def setup_logger() -> logging.Logger:
    logger = logging.getLogger("EXPRESSION_ORALE")
...
# ==================== EXPRESSION ORALE PROCESSING ====================

print("\n" + "=" * 80)
print("EXPRESSION ORALE - COURSE GRADEBOOK PROCESSING")
print("=" * 80 + "\n")

logger = setup_logger()
source_file = 'NOTAS FRANCÉS 2019-1.xls'
sheet_name = 'EXPRESSION ORALE 03'

# Create processor for EXPRESSION ORALE
...
if processor.run_pipeline(output_dir='pdfs_expression_orale',
...
if processor.run_pipeline(output_dir='pdfs_expression_orale'):
    ...
    print("\n" + "=" * 80)
    print("EXPRESSION ORALE - DETAILED ANALYSIS")
    print("=" * 80)
    ...
    for i, student in enumerate(processor.students, 1):
    ...
    print(f"\n✓ Generated {len(processor.pdf_files)} PDFs in pdfs_expression_orale/")
